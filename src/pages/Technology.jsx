...
const Technology = ({technology}) => {
    ...
    return (
        <section className="technology overflow-hidden bg-cover bg-[url(./assets/technology/background-technology-mobile.jpg)] md:bg-[url(./assets/technology/background-technology-tablet.jpg)] lg:bg-[url(./assets/technology/background-technology-desktop.jpg)] min-h-[100svh]">
            ...
            <div className="tech-container pb-12 lg:w-[89%] lg:ml-auto 2xl:p-0">
