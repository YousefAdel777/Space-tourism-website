...
const Destinations = ({destinations}) => {
    ...
    return (
        <section className="destinations overflow-hidden bg-cover flex items-center bg-[url(./assets/destination/background-destination-mobile.jpg)] md:bg-[url(./assets/destination/background-destination-tablet.jpg)] lg:bg-[url(./assets/destination/background-destination-desktop.jpg)] min-h-[100svh]">
            <div className="container pb-12 mt-40 2xl:p-0">
